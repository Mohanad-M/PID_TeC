...
#ifndef RTW_HEADER_PI_TeC_PIControl_types_h_
#define RTW_HEADER_PI_TeC_PIControl_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_PI_TeC_PIControl_T
#define typedef_cell_PI_TeC_PIControl_T

typedef struct tag_GtaT2TPu8wQVLKHBwLo3ME cell_PI_TeC_PIControl_T;

#endif                                 /*typedef_cell_PI_TeC_PIControl_T*/
...
{
  cell_PI_TeC_PIControl_T AvailablePwmPinNames;
};
...
typedef struct tag_ZksrEzekLFp3nSi7noWstB codertarget_arduinobase_int_g_T;

#endif                               /*typedef_codertarget_arduinobase_int_g_T*/

/* Parameters (default storage) */
typedef struct P_PI_TeC_PIControl_T_ P_PI_TeC_PIControl_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PI_TeC_PIControl_T RT_MODEL_PI_TeC_PIControl_T;

#endif                                /* RTW_HEADER_PI_TeC_PIControl_types_h_ */
