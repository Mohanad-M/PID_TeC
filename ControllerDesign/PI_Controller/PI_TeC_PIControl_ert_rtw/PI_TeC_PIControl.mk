###########################################################################
## Makefile generated for Simulink model 'PI_TeC_PIControl'. 
## 
## Makefile     : PI_TeC_PIControl.mk
## Generated on : Wed Jul 13 03:02:47 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PI_TeC_PIControl.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PI_TeC_PIControl.elf
...
DEFINES_ = -DMODEL=PI_TeC_PIControl -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_TIMERID=2 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=25 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=PI_TeC_PIControl -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_AnalogInput.o PI_TeC_PIControl.o PI_TeC_PIControl_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PI_TeC_PIControl.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/PI_TeC_PIControl.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PI_TeC_PIControl_data.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/PI_TeC_PIControl_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/PI_TeC_PIControl_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
